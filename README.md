...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/601cbec14427340016ec73e0
...
To start editing your site, you can use the Sanity interface at https://graceful-iron-cbec1.sanity.studio/.
...
Generated at `2021-02-05T03:46:27.276Z` by Stackbit version `0.3.47`.